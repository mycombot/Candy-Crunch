		...
		var getNewOverlay = function(){
			...
			return function(type, row, column) { //x/y/z, z optional.
				...
				try {
					...
					header.getMeasuredHeight = function() {return 12;};
					header.getMeasuredWidth = function() {return 100;};
					text.getMeasuredHeight = function() {return 10;};
					text.getMeasuredWidth = function() {return 100;};
				}
